...
class ProductsController extends Controller
{
    ...
    public function cart()
    {
        ...
        $meta_title = 'Shopping Cart - REAAL E-Commerce Platform';
        $meta_keywords = 'shopping cart, reaal e-commerce';
    ...
    {
        // Fetch all the world countries from the database table `countries`
        // get the countries which have status = 1 (to ignore the blacklisted countries, in case)
        ...
        foreach ($deliveryAddresses as $key => $value) {
            ...
            // Note that    $value['pincode']    denotes the `pincode` of the `delivery_addresses` table
