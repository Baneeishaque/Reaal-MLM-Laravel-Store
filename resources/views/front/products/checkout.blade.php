                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="order-h6">INR{{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">INR{{ $total_price }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            <span class="shipping_charges">INR0</span>
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
